...
if(isset($_POST['login']))
{
	...
	try{
		...
		$row=0;
		$result=mysqli_query($conn,"select * from admininfo where username='$_POST[username]' and password='$_POST[pass]' and type='$_POST[type]'");
	...
	<div class="row">
		...
		<form method="post" class="form-horizontal col-md-6 col-md-offset-3">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-7">
			      <input type="password" name="pass"  class="form-control" id="input1" placeholder="your password" />
			    </div>
			</div>
